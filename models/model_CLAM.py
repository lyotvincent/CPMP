...
class CLAM_SB(nn.Module):
    def __init__(self, gate = True, size_arg = "small", dropout = False, k_sample=8, n_classes=2,
        ...
        self.size_dict = {"small": [1024, 512, 256], 
                          "big": [1024, 512, 384], 
                          "ccl2048": [2048, 512, 256], 
                          "ctrans768": [768, 512, 256],
                          "uni1024": [1024, 512, 256]}
    ...
    def forward(self, h, label=None, return_features=False, attention_only=False, **kwargs):
        ...
        if self.instance_eval and label is not None and not self.surv:
            ...
            all_preds = []
            all_targets = []
            inst_labels = F.one_hot(label, num_classes=2).squeeze() #binarize label
        ...
        if self.surv:
            ...
            if self.classifiers.out_features == 1:
                ...
                return Y_prob, A_raw, results_dict
