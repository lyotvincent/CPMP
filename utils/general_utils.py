...
from .utils import collate_MIL, collate_MIL_regression, collate_pathol_factor_surv
...
def _get_split_loader(args, split_dataset, training = False, testing = False, weighted = False, batch_size=1):
    ...
    if args.task == "survival":
        collate_fn = collate_pathol_factor_surv 
    elif args.task == "MMPrisk":
        collate_fn = collate_MIL
    elif args.task == "MMPriskRegression":
